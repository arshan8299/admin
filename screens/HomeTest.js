...
const HomeTest = () => {
    ...
    const fetchUser = async () => {
      try {
        ...
        if (refreshToken) {
          ...
          const response = await axiosPrivate.get("/user-auth/refresh", {
  ...
  return (
    <View>
      ...
      >
        <CustomDrawerContent color="white" paddingLeft={30} pt={10} />
        ...
        >
          <View>
            <Text
              style={{ fontSize: "25", color: "white", paddingRight:10 }}
        ...
        >
          <View>
            ...
            >
              ...
              >
                <FontAwesome5 name="home" size={34} color="#246EE9" />
                <View>
                  <Pressable onPress={()=>navigation.navigate("AllProperties")}>
                  <Text
                    style={{
                      textAlign: "center",
                      color: "black",
          ...
          <View>
            ...
            >
              ...
              >
                {/* <FontAwesome5 name="home" size={34} color="#246EE9" /> */}
                <AntDesign name="eye" size={34} color="#246EE9" />
                <View>
                  <Text
                    style={{
                      textAlign: "center",
          ...
          <View>
            ...
            >
              ...
              >
                {/* <FontAwesome5 name="home" size={34} color="#246EE9" /> */}
                <FontAwesome5 name="handshake" size={34} color="#246EE9" />
                <View>
                  <Text
                    style={{
                      textAlign: "center",
